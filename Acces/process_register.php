...
// Ce fichier traite l'inscription des nouveaux utilisateurs
...
// var_dump(session_start());
    // var_dump($prenom, $nom, $email, $password, $confirm_password, $terms, $newsletter);
    // Validation
    ...
    // TODO: Connexion à la base de données et création du compte
    ...
    if($stmt->fetch()) {
        ...
        header('Location: ../Acces/register.php');
        exit();
    }
